...
var cases = [
    ...
    ["sin(x) = 1", "ERR"], ["()", "ERR"], ["2,3", "ERR"], ["sin()", "ERR"], ["2^1024", "ERR"], ["171!", "ERR"],
    // edges
    ["(-2)^3", -8], ["(-2)^2^2", 16], ["-(-2)^2", -4], ["2^(-1)", 0.5], ["(-8)^(1/3)", "ERR"], ["root(-8, 3)", -2],
    ["1e21", 1e21], ["1e21 + 1e21", 2e21], ["2^1e1", 1024], ["1e3^2", 1e6], ["0.1 + 0.2", 0.3], ["sin (pi/2)", 1],
    ["h() = 7", "h"], ["h()", 7], ["h() + 1", 8], ["sum(i=1, 3, sum(j=1, i, j))", 10], ["sum(i = 1, 3, i)", 6],
    ["2 - -3", 5], ["2 + -3", -1], ["2*+3", 6], ["-2*-3", 6], ["1-2-3", -4], ["1 - 2 * 3 ^ 2", -17],
    ["0.5!", Math.sqrt(Math.PI) / 2], ["ncr(50, 25)", 126410606437752], ["gcd(0, 5)", 5], ["lcm(3, 4, 6)", 12],
    ["mod(-7, 3)", 2], ["-7 % 3", -1], ["round(pi, 2)", 3.14], ["atan(1, 1)", Math.PI / 4], ["max(1)", 1],
    ["PI", Math.PI], ["Sin(0)", 0], ["A = 5", 5], ["a", 5], ["forgetme = 1", 1],
];
